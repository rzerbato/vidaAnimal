	...
	<div class="col-md-3 col-md-offset-1 col-xs-12">
		...
		<div class="form-group">
			...
			<div class="input-group">
				<input class="span4 form-control" placeholder="Rubro" name="SubRubro[rubro_idRubro]" id="SubRubro_rubro_idRubro" type="text"/>
...
function seleccionarRubro(){
	...
	$.ajax({
          ...
          success: function(response){
                  $('#SubRubro_rubro_idRubro').val(response['nombre']);
          }
  });
}
