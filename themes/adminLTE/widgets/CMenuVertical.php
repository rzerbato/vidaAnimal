 ...
 * @since 1.1
 */
class CMenuVertical extends CWidget
{
	/**
	...
	protected function renderMenu($items)
	{
		if(count($items))
		{
			...
			echo CHtml::openTag('aside', array('class'=>'main-sidebar'));//<aside class="main-sidebar">
				echo CHtml::openTag('section', array('class'=>'sidebar'));//<section class="sidebar">
                        echo  "\n".CHtml::openTag('ul', array('class'=>'sidebar-menu'));//<ul class="sidebar-menu">
						$this->renderMenuRecursive($items);
						echo CHtml::closeTag('ul');//<!-- ul -->
				echo  "\n".CHtml::closeTag('section');//<!-- /section -->
			echo  "\n".CHtml::closeTag('aside');//<!-- /aside -->
