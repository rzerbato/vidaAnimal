<?php
/**
 * CMenuTopNotificaciones class file.
 *
 ...
 * @since 1.1
 */
class CMenuTopNotificaciones extends CWidget
{
	/**
	...
	protected function renderMenu($items)
	{
		if(count($items))
		{
			...
			echo CHtml::openTag('nav', array('class'=>'navbar navbar-static-top'));
			echo CHtml::openTag('a', array('class'=>'sidebar-toggle','data-toggle'=>'offcanvas','role'=>'button'));
		    echo CHtml::openTag('span', array('class'=>'sr-only'));echo("Toggle navigation");echo CHtml::closeTag('span');//<!-- span -->
		    echo CHtml::closeTag('a');//<!-- a -->

		    	//echo CHtml::openTag('div', array('class'=>'navbar-custom-menu'));
		    	echo CHtml::openTag('div', array('class'=>'nav navbar-nav'));
		    	echo  "\n".CHtml::openTag('ul', array('class'=>'nav navbar-nav'));
                    $this->renderMenuRecursive($items);
                echo CHtml::closeTag('ul');//<!-- <ul class="nav navbar-nav"> -->
                echo CHtml::closeTag('div');//<!--div -->

			
			echo CHtml::closeTag('nav');//<!-- nav -->

			//array('label'=>'<i class="fa fa-user fa-fw"></i>'.Yii::app()->user->name,'url'=>array(''))
		}
	}
	...
	protected function renderMenuRecursive($items)
	{
		...
		foreach($items as $item)
		{
			...
			{
                                /*echo  "\n".CHtml::openTag('span',array('class'=>'fa arrow'));
