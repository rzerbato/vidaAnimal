                            ...
                            array('label'=>'<i class="fa fa-newspaper-o"></i><span>Artículos</span> ', 'url'=>'#',
                             ...
                             array('label'=>'<i class="fa fa-calculator"></i><span>Actualiza Precios</span> ', 'url'=>'#',
                             		'itemOptions'=>array('class'=>'treeview'),
                                      'submenuOptions'=>array('class'=>'treeview-menu'),
                                      'items'=>array(
                                        array('label'=>'<i class="fa fa-usd"></i><span>Configuración de Precios</span>', 'url'=>array('/configprecio/update/1')),
                                         ...
                                         array('label'=>'<i class="fa fa-id-card"></i><span>Actualiza por Marca</span>', 'url'=>array('/producto/actualizaPreciosMarca')),
                             ...
                             array('label'=>'<i class="fa fa-plus"></i><span>Clínica</span> ', 'url'=>'#',
                             		'itemOptions'=>array('class'=>'treeview'),
                                      'submenuOptions'=>array('class'=>'treeview-menu'),
                                      'items'=>array(
                                         array('label'=>'<i class="fa fa fa-check-square-o"></i> <span>Tipo Consulta</span>', 'url'=>array('/tipoConsulta/Admin')),
                                         array('label'=>'<i class="fa fa-paw"></i> <span>Paciente</span>','url'=>array('/paciente/admin/')),


                              )),

                              array('label'=>'<i class="fa fa-usb"></i><span>Herramientas</span> ', 'url'=>'#',
                              'itemOptions'=>array('class'=>'treeview'),
                                   'submenuOptions'=>array('class'=>'treeview-menu'),
                                   'items'=>array(
                                      array('label'=>'<i class="fa fa-floppy-o"></i> <span>Backup</span>', 'url'=>array('/backup')),
                              )),
